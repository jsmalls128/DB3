...
//        index     = new LinHashMap <> (KeyType.class, Comparable [].class);
    ...
    { 
    	...
    	for(int i = 0; i < t.length; i++) {
			...
			Class tupleType = t[i].getClass();
    		Class domainType = domain[i];
    		
    		if(tupleType.equals(Double.class) && domainType.equals(Float.class)){
    			domainType = tupleType;
    		}
    		if(!tupleType.equals(domainType)) {
